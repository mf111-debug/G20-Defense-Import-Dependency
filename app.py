...
if show_events:
    ...
    for date_str, label, ecolor in [
        ('2010-01-01', 'Haiti Earthquake',              '#A0A0A0'),
        ('2011-01-01', 'Arab Spring',                   '#7B68EE'),
        ('2011-03-01', 'Libya Civil War',               '#9B59B6'),
        ('2011-03-11', 'Japan Tsunami & Nuclear Crisis','#FF6B6B'),
        ('2013-06-01', 'Syria Escalates',               '#8E44AD'),
        ('2014-03-01', 'Russia Annexes Crimea',         '#E74C3C'),
        ('2014-06-01', 'ISIS Declares Caliphate',       '#C0392B'),
        ('2015-03-01', 'Yemen War Begins',              '#FF8C00'),
        ('2015-11-01', 'Paris Terror Attacks',          '#D35400'),
        ('2016-04-01', 'Saudi Vision 2030',             '#C8F542'),
        ('2016-06-01', 'Brexit Vote',                   '#3498DB'),
        ('2017-01-01', 'Trump Defense Build-Up',        '#5DADE2'),
        ('2018-03-01', 'US-China Trade War Begins',     '#4682B4'),
        ('2019-12-01', 'COVID-19 First Cases',          '#F0E68C'),
        ('2020-03-01', 'COVID-19 Global Pandemic',      '#AA8800'),
        ('2021-08-01', 'Afghanistan Withdrawal',        '#F39C12'),
        ('2022-02-01', 'Russia Invades Ukraine',        '#CC4444'),
        ('2022-08-01', 'Taiwan Strait Crisis',          '#E74C3C'),
        ('2023-01-01', 'India Surpasses China in Pop.', '#FF9933'),
        ('2023-10-01', 'Israel-Hamas War',              '#CD853F'),
        ('2024-01-01', 'NATO Defense Expansion',        '#2ECC71'),
        ('2024-04-01', 'Iran Attacks Israel Directly',  '#B22222'),
    ]:
